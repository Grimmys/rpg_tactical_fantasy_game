...
def create_options_menu(params):
    entries = [[load_parameter_entry("Move speed : ",
               ...
               [load_parameter_entry("Difficulty : ", 
                                     [{'label': '0.1', 'value': DIFFICULTY + 0.1},
                                     {'label': '0.2', 'value': DIFFICULTY + 0.2},
                                     {'label': '0.3', 'value': DIFFICULTY + 0.3},
                                     {'label': '0.4', 'value': DIFFICULTY + 0.4},
                                     {'label': '0.5', 'value': DIFFICULTY + 0.5},
                                     {'label': '0.6', 'value': DIFFICULTY + 0.6},                                     
                                     {'label': '0.7', 'value': DIFFICULTY + 0.7},
                                     {'label': '0.8', 'value': DIFFICULTY + 0.8},                                     
                                     {'label': '0.9', 'value': DIFFICULTY + 0.9},
                                     {'label': '1.0', 'value': DIFFICULTY + 1.0},                                                                          
                                     ],
                                     params['difficulty'],
