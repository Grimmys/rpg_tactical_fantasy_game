...
STR_CONTROLS_TITLE = "控制"
STR_CONTROLS_INPUT_HEADER = "输入"
STR_CONTROLS_DESCRIPTION_HEADER = "效果"
STR_CONTROLS_INPUT_LEFT_CLICK = "左键点击"
STR_CONTROLS_INPUT_LEFT_CLICK_EMPTY = "左键点击（空格）"
STR_CONTROLS_INPUT_LEFT_CLICK_ENTITY = "左键点击（实体）"
STR_CONTROLS_INPUT_RIGHT_CLICK = "右键点击"
STR_CONTROLS_INPUT_RIGHT_CLICK_ENTITY = "右键点击（实体）"
STR_CONTROLS_INPUT_ESC = "Esc键"
STR_CONTROLS_INPUT_F1 = "F1键"
STR_CONTROLS_INPUT_HINT = "提示"
STR_CONTROLS_LEFT_CLICK = "选择一个玩家，选择一个格子，或选择一个动作。"
STR_CONTROLS_LEFT_CLICK_EMPTY = "打开或关闭主菜单。"
STR_CONTROLS_LEFT_CLICK_ENTITY = "显示一个活动实体的信息窗口。"
STR_CONTROLS_RIGHT_CLICK = "取消选择一个玩家或取消上一个动作（如果可能）。"
STR_CONTROLS_RIGHT_CLICK_ENTITY = "显示悬停实体的可能移动。"
STR_CONTROLS_ESC = "关闭当前顶层菜单（动作菜单除外）。"
STR_CONTROLS_F1 = "显示或隐藏此控制摘要。"
STR_CONTROLS_LEVEL_HINT = "你可以在每个关卡按F1键查看这些控制说明。"
