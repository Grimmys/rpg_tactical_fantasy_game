...
STR_CONTROLS_LEFT_CLICK = "Sélectionner un joueur, choisir une case ou choisir une action."
STR_CONTROLS_LEFT_CLICK_EMPTY = "Ouvrir ou fermer le menu principal."
STR_CONTROLS_LEFT_CLICK_ENTITY = "Afficher la fenêtre d'information d'une entité active."
STR_CONTROLS_RIGHT_CLICK = "Désélectionner un joueur ou annuler la dernière action si possible."
STR_CONTROLS_RIGHT_CLICK_ENTITY = "Afficher les mouvements possibles de l'entité survolée."
STR_CONTROLS_ESC = "Fermer le menu actuellement au premier plan (sauf le menu d'action)."
STR_CONTROLS_F1 = "Afficher ou masquer ce résumé des contrôles."
