...
STR_CONTROLS_TITLE = "Contrôles"
STR_CONTROLS_INPUT_HEADER = "Entrée"
STR_CONTROLS_DESCRIPTION_HEADER = "Effet"
STR_CONTROLS_INPUT_LEFT_CLICK = "Clic gauche"
STR_CONTROLS_INPUT_LEFT_CLICK_EMPTY = "Clic gauche (case vide)"
STR_CONTROLS_INPUT_LEFT_CLICK_ENTITY = "Clic gauche (entité)"
STR_CONTROLS_INPUT_RIGHT_CLICK = "Clic droit"
STR_CONTROLS_INPUT_RIGHT_CLICK_ENTITY = "Clic droit (entité)"
STR_CONTROLS_INPUT_ESC = "Touche Échap"
STR_CONTROLS_INPUT_F1 = "Touche F1"
STR_CONTROLS_INPUT_HINT = "Indice de niveau"
STR_CONTROLS_LEFT_CLICK = "Sélectionnez un joueur, choisissez une case ou choisissez une action."
STR_CONTROLS_LEFT_CLICK_EMPTY = "Ouvrez ou fermez le menu principal."
STR_CONTROLS_LEFT_CLICK_ENTITY = "Affichez la fenêtre d'information d'une entité active."
STR_CONTROLS_RIGHT_CLICK = "Désélectionnez un joueur ou annulez la dernière action si possible."
STR_CONTROLS_RIGHT_CLICK_ENTITY = "Affichez les mouvements possibles de l'entité survolée."
STR_CONTROLS_ESC = "Fermez le menu actuellement au premier plan (sauf le menu d'action)."
STR_CONTROLS_F1 = "Affichez ou masquez ce résumé des contrôles."
STR_CONTROLS_LEVEL_HINT = "Vous pouvez appuyer sur F1 à chaque niveau pour revoir ces contrôles."
# Reward menu
